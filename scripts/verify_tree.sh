...
check web/index.html          "mergedSegs"             "birlesik takvim (lokal+bulut tek gorunum)"
check web/index.html          "camDays"                "tekli oynatimda da birlesik gunler"
check web/index.html          "attachZoom"             "tikla-buyut (3 kademe)"
check web/index.html          "jogTime"                "jog realtime buyuk saat"
check web/index.html          "calGrid"                "aylik takvim"
check web/index.html          "selCams"                "senkron kamera secimi (limit 4)"
check web/index.html          "camOff"                 "faz farki menusu"
check web/index.html          "clampSeek"              "canli arkasi kor bolge kelepcesi"
...
check web/index.html          "goLive"                 "kesintisiz canli-gecmis (time-shift)"
